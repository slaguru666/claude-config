...
- [ ] **scenario-forge live acceptance test** — build AFTERIMAGE, import into a scratch Foundry world, open it. The one thing the spike could not verify [[scenario-forge]]
